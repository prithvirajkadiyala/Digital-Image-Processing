...
axis off;
axis ('image');
print (figure(1),'2ca','-dpng');%writing out image for LaTeX purpose
...
axis off;
axis ('image');
print (figure(2),'2cb','-dpng');%writing out image for LaTeX purpose
...
axis off;
axis ('image');
print (figure(3),'2cc','-dpng');%writing out image for LaTeX purpose
...
axis off;
axis ('image');
print (figure(5),'2cd','-dpng');%writing out image for LaTeX purpose
...
axis off;
axis ('image');
print (figure(6),'2ce','-dpng');%writing out image for LaTeX purpose
...
axis off;
axis ('image');
print (figure(7),'2cf','-dpng');%writing out image for LaTeX purpose
